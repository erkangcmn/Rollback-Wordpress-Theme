...
<p><label for="email"><small>Email (will not be published) <?php if ($req) echo "(required)"; ?></small></label>
...
<p><textarea name="comment" id="comment" cols="40" rows="8" tabindex="4"></textarea></p>
